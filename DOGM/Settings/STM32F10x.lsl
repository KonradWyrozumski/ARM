// define rom size
#define __ROM_SIZE               128k
#define __ROM_ADDR               0x08000000
// define ram size
#define __RAM_SIZE               20k
#define __RAM_ADDR               0x20000000

// CHANGED 1-8-2007 by TASKING HS (set to 59)
#define __NR_OF_VECTORS          59
#define __VECTOR_TABLE_SIZE      (__NR_OF_VECTORS * 4)
#define __VECTOR_TABLE_ROM_ADDR  0x08000000
#define _Vectors                 0x08000000

#define _ENTRYADDR               (0x08000001 + __VECTOR_TABLE_SIZE + 80) /* xB0 */ 

#define _START                   max(_ENTRYADDR, 0x08000165)

#define __RESET                  0x08000004

#define __STACK                  4k
#define __STACKADDR              (__RAM_ADDR + __RAM_SIZE - __STACK)
#define __HEAP                   2k

#define __TABLE_RAM_SIZE         200
...
//		 REMOVED 1-8-2007 by TASKING HS
